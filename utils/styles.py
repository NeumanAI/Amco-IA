    ...
    css = f"""
        <style>
            ...
            /* Main content padding */
             ...
             /* Estilos para los enlaces del menú (st.page_link) */
             section[data-testid="stSidebar"] [data-testid="stPageLink-NavLink"] {{
                 padding: 0.4rem 0.5rem 0.4rem 0.8rem !important; /* Padding: Arriba/Abajo, Derecha, Izquierda */
                 border-radius: 0.3rem;
                 transition: background-color 0.2s ease, color 0.2s ease;
                 margin-bottom: 2px; /* Pequeño espacio entre enlaces */
             }}
             section[data-testid="stSidebar"] [data-testid="stPageLink-NavLink"]:hover {{
                 background-color: #E7E7E7; /* Color de fondo sutil al pasar el mouse */
             }}
             /* Apuntamos al párrafo dentro del enlace para cambiar el tamaño de la fuente */
             section[data-testid="stSidebar"] [data-testid="stPageLink-NavLink"] p {{
                 font-size: 15px !important;      /* <<< TAMAÑO DE FUENTE AJUSTADO */
                 font-weight: 400 !important;    /* Peso de fuente normal (no negrita) */
                 color: var(--sidebar-text) !important;
             }}
             /* === FIN: CÓDIGO AÑADIDO === */
...
def force_full_width_layout():
    """
    Aplica JavaScript para forzar el layout a ancho completo y ajusta el padding.
    """
    js_code = """
    <script>
    ...
    function enforceFullWidth() {
        ...
        // El nombre de la clase puede cambiar, pero querySelector lo encontrará.
        ...
        if (mainContainer) {
            ...
            // Cambiamos el padding superior de 6rem a 3.5rem para reducir el espacio en blanco.
            mainContainer.style.padding = '3.5rem 2rem 10rem';
            // --- FIN DE LA CORRECCIÓN ---

            console.log("Applied full width and adjusted padding to main container");
        }
        
        // Other possible containers (sin cambios)
        const containers = [
