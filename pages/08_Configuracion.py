# Archivo: pages/08_Configuracion.py
...
from database.models import LanguageModelOption, SkillOption, PersonalityOption, GoalOption
import logging
...
# --- Funciones Auxiliares para CRUD de Opciones (SIN CAMBIOS) ---
...
def options_agents_tab_content():
    ...
    with opt_tabs[1]: crud_options_ui(SkillOption, "Habilidad", "Habilidades")
